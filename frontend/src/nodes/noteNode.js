...
// // Premium Note Area: High-readability typography
// const NoteEditor = styled(FieldTextarea)`
//   min-height: 100px;
//   line-height: 1.6;
//   font-size: 13px;
//   background: rgba(255, 212, 59, 0.03) !important; /* Extremely subtle gold tint */
//   border: 1px dashed rgba(255, 212, 59, 0.15) !important; /* Dashed border for "Annotation" feel */
//   color: #e2e8f0;
//   padding: 14px;
//   border-radius: 8px;
//   font-style: italic;
...
//       id={id} 
//       title="Annotation" 
//       icon={<StickyNote size={14} strokeWidth={2.5} color="#fbbf24" />} 
//       handles={[]} 
//       minWidth={280}
//     >
//       <NodeField>
//         <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '2px' }}>
//           <AlignLeft size={10} color="#475569" />
//           <FieldLabel>Observations</FieldLabel>
//         </div>

//         <NoteEditor 
//           placeholder="Document your workflow logic here..."
//           value={note}
//           onChange={handleNoteChange}
//         />

//         <NoteMetadata>
//           <span>System Log Node</span>
